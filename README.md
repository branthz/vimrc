...
* **The Basic**: If you want something small just copy [basic.vim](https://github.com/branthz/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a good basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:
    ...
    git clone --depth=1 https://github.com/branthz/vimrc.git ~/.vim_runtime
...
The basic version is just one file and no plugins. Just copy [basic.vim](https://github.com/branthz/vimrc/blob/master/vimrcs/basic.vim) and paste it into your vimrc.

The basic version is useful to install on remote servers where you don't need many plugins, and you don't do many edits.

	git clone --depth=1 git://github.com/branthz/vimrc.git ~/.vim_runtime
